...
##--------------------------------------------------------------------\
#   ArrayCalculator  test_hamming_array.py
#
#   Tests for the Hamming array (hamming_array.py): first sidelobe near
#   -41 dB, computed from the actual array factor.
##--------------------------------------------------------------------\
...
class TestHammingArrayCLI:
    def test_variable_return(self):
        shell = ArrayCalculator(["hamming_array", "-N", "12", "--variable_return"])
