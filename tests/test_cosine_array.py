...
##--------------------------------------------------------------------\
#   ArrayCalculator  test_cosine_array.py
#
#   Tests for the Cosine array (cosine_array.py): first sidelobe near
#   -23.3 dB, computed from the actual array factor.
##--------------------------------------------------------------------\
...
class TestCosineArrayCLI:
    def test_variable_return(self):
        shell = ArrayCalculator(["cosine_array", "-N", "12", "--variable_return"])
